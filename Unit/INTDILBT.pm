...
my @modules = (
  'DB-Artist Doodles',
  'DB-Best Of Dilbert',
  'DB-Bob Gives Wedgies',
  'DB-Budget Woes',
  'DB-Conference Room of Horrors',
  'DB-Cyberspace',
  'DB-Dilbert Presents',
  'DB-Dilbert at Work',
  'DB-Happy Ratbert',
  ...
  'DB-Out to Lunch',
  'DB-Saint Dogbert',
  'DB-Secretary with a Crossbow',
  'DB-Thor Dog of Thunder',
  'DB-Whack a Lawyer',
);
...
sub info {
    return (
        name     => 'INTDILBT',
        fullname => 'Dilbert Screensaver Collection',
        author   => 'Delrina Software',
        payload  => ['INTDILBT.zip'],
        files    => {
